...
/******/ 	var hotCurrentHash = "59cbfdf43bbd333dbf87";
...
/***/ function(module, exports, __webpack_require__) {
	...
	it("should parse multiple expressions in a require", function(done) {
		var name = "abc";
		__webpack_require__.e/* require */(1, function(__webpack_require__) { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(/*! . */ 1)("./" + name + "/" + name + "Test")]; (function(x) {
			x.should.be.eql("ok");
			done();
