...
/******/ 	var hotCurrentHash = "ff13e07c47d205f7b3f8";
...
/***/ function(module, exports, __webpack_require__) {
	...
	it("should allow combinations of async and sync loaders", function() {
		__webpack_require__(/*! ./loaders/syncloader!./a */ 1).should.be.eql("a");
		__webpack_require__(/*! ./loaders/asyncloader!./a */ 4).should.be.eql("a");

		__webpack_require__(/*! ./loaders/syncloader!./loaders/syncloader!./a */ 2).should.be.eql("a");
		__webpack_require__(/*! ./loaders/syncloader!./loaders/asyncloader!./a */ 5).should.be.eql("a");
		__webpack_require__(/*! ./loaders/asyncloader!./loaders/syncloader!./a */ 6).should.be.eql("a");
		__webpack_require__(/*! ./loaders/asyncloader!./loaders/asyncloader!./a */ 7).should.be.eql("a");

		__webpack_require__(/*! ./loaders/asyncloader!./loaders/asyncloader!./loaders/asyncloader!./a */ 8).should.be.eql("a");
		__webpack_require__(/*! ./loaders/asyncloader!./loaders/syncloader!./loaders/asyncloader!./a */ 9).should.be.eql("a");
		__webpack_require__(/*! ./loaders/syncloader!./loaders/asyncloader!./loaders/syncloader!./a */ 10).should.be.eql("a");
		__webpack_require__(/*! ./loaders/syncloader!./loaders/syncloader!./loaders/syncloader!./a */ 3).should.be.eql("a");
	});
